...
class WC_Shipping_Paps extends WC_Shipping_Method
{
  ...
  public function __construct($instance_id = 0)
  {
    ...
    $method_title = __('Paps (Standard)', 'paps-shipping');

    $this->method_title = $method_title;
    $this->method_description = __('Paps Shipping Support', 'paps-shipping');
    $this->init();
  ...
  private function init()
  {
    ...
    $this->title = __('Livraison Standard (Paps)', 'paps-shipping');

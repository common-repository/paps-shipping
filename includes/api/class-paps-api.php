    ...
    if ($type == 'admin') {
      switch ($status) {
        case 'sent_but_not_started':
          return __('Envoyée à Paps', 'paps-shipping');
          break;
        case 'cancelled':
          return __('Livraison Annulée', 'paps-shipping');
          break;
        case 'pickup_started':
          return __('Pickup commmencé', 'paps-shipping');
          break;
        case 'pickup_completed':
          return __('Pickup Terminé', 'paps-shipping');
          break;
        case 'dropoff_started':
          return __('Livraison commencée', 'paps-shipping');
          break;
        case 'dropoff_completed':
          return __('Livrée', 'paps-shipping');
          break;
        default:
          return null;
          break;
    ...
    if ($type == 'user') {
      switch ($status) {
        ...
        case 'dropoff_started':
          ...
          break;
        case 'dropoff_completed':
          return __('Le colis a été livré.', 'paps-shipping');
          break;
        default:
          return null;
          break;
